...
libraryDependencies += "org.xerial"          % "sqlite-jdbc"          % "3.36.0.1"    % "test" // latest version that works
...
libraryDependencies += "org.postgresql"      % "postgresql"           % "42.2.23"    % "test"

libraryDependencies += "mysql"               % "mysql-connector-java" % "8.0.26"    % "test"

libraryDependencies += "org.slf4j"           % "slf4j-simple"         % "1.7.31"    % "test"
